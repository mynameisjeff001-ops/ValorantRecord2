((
  ...
  try {
    ...
    return `${playerName} is ${fullStreamEloChange >= 0 ? 'up' : 'down'} ${fullStreamEloChange} RR this stream. Currently ${winCountThisStream}W - ${lossCountThisStream}L - ${drawCountThisStream}D. ${LastGameMmrChange >= 0 ? 'Won' : 'Lost'} ${Math.abs(LastGameMmrChange)} last game.`;
  } catch (e) {
