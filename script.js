((
  ...
  try {
    ...
    return `${playerName} is ${fullStreamEloChange >= 0 ? 'up' : 'down'} ${fullStreamEloChange} RR this stream. Currently ${winCountThisStream} wins - ${lossCountThisStream} losses - ${drawCountThisStream} draws.`;
  } catch (e) {
