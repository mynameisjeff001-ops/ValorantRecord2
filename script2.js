((
  ...
  try {
    ...
    return `${playerName} is ${fullStreamEloChange >= 0 ? 'up' : 'down'} ${fullStreamEloChange} RR this stream. Currently ${winCountThisStream}W - ${lossCountThisStream}L - ${drawCountThisStream}D. ${mmrChange >= 0 ? 'Won' : 'Lost'} ${mmr_change_to_last_game} last game.`;
  } catch (e) {
